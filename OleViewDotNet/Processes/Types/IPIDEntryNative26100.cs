...
// Win 26100+ (24H2) tagIPIDEntry layout adds 'flags' at +0x0c and 'pInterfaceName' at +0x68.
[StructLayout(LayoutKind.Sequential)]
internal struct IPIDEntryNative26100 : IPIDEntryNativeInterface
{
    ...
    IPIDEntryNativeInterface IPIDEntryNativeInterface.GetNext(NtProcess process)
    {
        if (pNextIPID == IntPtr.Zero)
            return null;
        return process.ReadStruct<IPIDEntryNative26100>(pNextIPID.ToInt64());
    }
