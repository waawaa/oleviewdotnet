...
// Win 26100+ (24H2) tagIPIDEntry 32-bit layout adds 'flags' and 'pInterfaceName'.
[StructLayout(LayoutKind.Sequential)]
internal struct IPIDEntryNative26100_32 : IPIDEntryNativeInterface
{
    ...
    IPIDEntryNativeInterface IPIDEntryNativeInterface.GetNext(NtProcess process)
    {
        if (pNextIPID == 0)
            return null;
        return process.ReadStruct<IPIDEntryNative26100_32>(pNextIPID);
    }
